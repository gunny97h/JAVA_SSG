...
public class 포맷팅지정2 {
    public static void main(String[] args) {
        double positiveNumber = 1234567.89; double negativeNumber = -1234567.89;
        // +와 - 기호를 붙이고 소수점 이하 한 자리까지 포맷팅하는 패턴
        DecimalFormat df1 = new DecimalFormat("+#.0;-#.0");
        // 양수의 경우 + 기호와 함께 출력
        System.out.println(df1.format(positiveNumber));
        // 출력: +1234567.9
        // 음수의 경우 - 기호와 함께 출력
        System.out.println(df1.format(negativeNumber));
        // 출력: -1234567.9 } }
