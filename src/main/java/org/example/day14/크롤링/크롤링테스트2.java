...
public class 크롤링테스트2 {  // html paser
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(list);  // 개수와 상관없이 list로 가져와 인덱스 사용
...
//        System.out.println(tx);
        ...
        for (int i = 0; i < list5.size(); i++) {  // 인덱스 붙여서 list5 출력
            System.out.println(i + ": " + list5.get(i).text());
        }

        // 고가 high에 넣기
        Element high = list5.get(18);
        // 현재가 today에 넣기
        Element today = list5.get(21);
        // 전일가 yesterday에 넣기
        Element yesterday = list5.get(17);
        // 코드
        ...
        // 고가 :
        System.out.println("고가 : " + high.text());
        // 현재가 :
        System.out.println("현재가 : " + today.text());
        // 전일가 :
        System.out.println("전일가 : " + yesterday.text());
    }
}
